...
// FIXME: CHange how DexCalc works
...
export class Pokemon {
	...
	*/
	 ...
	 */
	setTemplate(rawTemplate: Template, source: Effect | null = this.battle.effect, isPermanent, message, abilitySlot = '0') {
		// Seems like we need to deepclone the template to avoid permanently altering the original here...
		rawTemplate = DexCalculator.deepClone(rawTemplate) 
	 ...
	 */
	// FIXME: it seems like this has been chaned to setTemplate and split into two methods?
	formeChange(templateId, source: Effect | null = this.battle.effect , isPermanent, message, abilitySlot = '0') {
